...
app.get("/getUser", async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    const response = await getUser(req.query.username as string);
    res.status(200).json(response);
  } catch (err) {
    next(err);
  }
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (req.query.token) {
        ...
        response = await listUsers(req.query.limit as unknown as number);
      } else {
        response = await listUsers();
      }
      res.status(200).json(response);
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (req.query.token) {
        ...
        response = await listGroups(req.query.limit as unknown as number);
      } else {
        response = await listGroups();
      }
      res.status(200).json(response);
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      if (req.query.token) {
        ...
        response = await listGroupsForUser(req.query.username as string);
      }
      res.status(200).json(response);
    } catch (err) {
      next(err);
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      if (req.query.token) {
        ...
        response = await listUsersInGroup(req.query.groupname as string);
      }
      res.status(200).json(response);
    } catch (err) {
      next(err);
