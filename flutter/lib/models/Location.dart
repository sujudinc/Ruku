...
class Location {
  ...
  const Location._internal({required addressLine1, addressLine2, required city, required province, required postalCode, required country, required latitude, required longitude}): _addressLine1 = addressLine1, _addressLine2 = addressLine2, _city = city, _province = province, _postalCode = postalCode, _country = country, _latitude = latitude, _longitude = longitude;
  
  factory Location({required String addressLine1, String? addressLine2, required String city, required String province, required String postalCode, required String country, required double latitude, required double longitude}) {
  ...
  Location copyWith({String? addressLine1, String? addressLine2, String? city, String? province, String? postalCode, String? country, double? latitude, double? longitude}) {
    return Location._internal(
  ...
  Map<String, dynamic> toJson() => {
    'addressLine1': _addressLine1, 'addressLine2': _addressLine2, 'city': _city, 'province': _province, 'postalCode': _postalCode, 'country': _country, 'latitude': _latitude, 'longitude': _longitude
  };
