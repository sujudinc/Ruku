...
class Mosque extends amplify_core.Model {
  ...
  const Mosque._internal({required this.id, required name, description, images, required location, required hours, contactInfo, liveVideoUrl, creator, followers, announcements, classes, committees, gatherings, fundraisingCampaigns, monthlyPrayerSchedules, resources, services, volunteerTasks, createdAt, updatedAt}): _name = name, _description = description, _images = images, _location = location, _hours = hours, _contactInfo = contactInfo, _liveVideoUrl = liveVideoUrl, _creator = creator, _followers = followers, _announcements = announcements, _classes = classes, _committees = committees, _gatherings = gatherings, _fundraisingCampaigns = fundraisingCampaigns, _monthlyPrayerSchedules = monthlyPrayerSchedules, _resources = resources, _services = services, _volunteerTasks = volunteerTasks, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Mosque({String? id, required String name, String? description, List<String>? images, required Location location, required Hours hours, ContactInfo? contactInfo, String? liveVideoUrl, User? creator, List<MosqueFollowers>? followers, List<Announcement>? announcements, List<Class>? classes, List<Committee>? committees, List<Gathering>? gatherings, List<FundraisingCampaign>? fundraisingCampaigns, List<MonthlyPrayerSchedule>? monthlyPrayerSchedules, List<Resource>? resources, List<Service>? services, List<VolunteerTask>? volunteerTasks}) {
