...
class SocialMedia {
  ...
  const SocialMedia._internal({facebook, twitter, instagram}): _facebook = facebook, _twitter = twitter, _instagram = instagram;
  
  factory SocialMedia({String? facebook, String? twitter, String? instagram}) {
  ...
  SocialMedia copyWith({String? facebook, String? twitter, String? instagram}) {
    return SocialMedia._internal(
  ...
  Map<String, dynamic> toJson() => {
    'facebook': _facebook, 'twitter': _twitter, 'instagram': _instagram
  };
