...
class Bookmark extends amplify_core.Model {
  ...
  const Bookmark._internal({required this.id, required announcement, required creator, required mosque, required createdAt, required updatedAt}): _announcement = announcement, _creator = creator, _mosque = mosque, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Bookmark({String? id, required Announcement announcement, required User creator, required Mosque mosque, required amplify_core.TemporalDateTime createdAt, required amplify_core.TemporalDateTime updatedAt}) {
  ...
  Bookmark copyWith({Announcement? announcement, User? creator, Mosque? mosque, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
    return Bookmark._internal(
      id: id,
