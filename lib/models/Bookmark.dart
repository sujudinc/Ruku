...
class Bookmark extends amplify_core.Model {
  ...
  const Bookmark._internal({required this.id, required announcement, required creator, required mosque, required createdAt, required updatedAt, owner}): _announcement = announcement, _creator = creator, _mosque = mosque, _createdAt = createdAt, _updatedAt = updatedAt, _owner = owner;
  
  factory Bookmark({String? id, required Announcement announcement, required User creator, required Mosque mosque, required amplify_core.TemporalDateTime createdAt, required amplify_core.TemporalDateTime updatedAt, String? owner}) {
  ...
  Bookmark copyWith({Announcement? announcement, User? creator, Mosque? mosque, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt, String? owner}) {
    return Bookmark._internal(
      id: id,
  ...
  Bookmark.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _announcement = json['announcement'] != null
        ? json['announcement']['serializedData'] != null
          ? Announcement.fromJson(new Map<String, dynamic>.from(json['announcement']['serializedData']))
          : Announcement.fromJson(new Map<String, dynamic>.from(json['announcement']))
        : null,
