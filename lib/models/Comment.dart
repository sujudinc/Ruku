...
class Comment extends amplify_core.Model {
  ...
  Comment.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _text = json['text'],
      _parentComment = json['parentComment'] != null
        ? json['parentComment']['serializedData'] != null
          ? Comment.fromJson(new Map<String, dynamic>.from(json['parentComment']['serializedData']))
          : Comment.fromJson(new Map<String, dynamic>.from(json['parentComment']))
        : null,
      _subComments = json['subComments']  is Map
        ? (json['subComments']['items'] is List
          ? (json['subComments']['items'] as List)
              .where((e) => e != null)
              .map((e) => Comment.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['subComments'] is List
