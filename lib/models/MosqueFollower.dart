...
class MosqueFollower extends amplify_core.Model {
  ...
  MosqueFollowerModelIdentifier get modelIdentifier {
      return MosqueFollowerModelIdentifier(
        id: id
      );
  }
  ...
  const MosqueFollower._internal({required this.id, required mosque, required user, createdAt, updatedAt}): _mosque = mosque, _user = user, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory MosqueFollower({String? id, required Mosque mosque, required User user}) {
  ...
  MosqueFollower copyWith({Mosque? mosque, User? user}) {
    return MosqueFollower._internal(
      id: id,
  ...
  MosqueFollower copyWithModelFieldValues({
  ...
  static final amplify_core.QueryModelIdentifier<MosqueFollowerModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<MosqueFollowerModelIdentifier>();
...
class _MosqueFollowerModelType extends amplify_core.ModelType<MosqueFollower> {
 ...
 * of [MosqueFollower] in your schema.
 */
class MosqueFollowerModelIdentifier implements amplify_core.ModelIdentifier<MosqueFollower> {
  final String id;

  /** Create an instance of MosqueFollowerModelIdentifier using [id] the primary key. */
  const MosqueFollowerModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'MosqueFollowerModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is MosqueFollowerModelIdentifier &&
      id == other.id;
  }
